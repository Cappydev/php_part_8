...
if (isset($_POST['login']) && isset($_POST['password'])) {
  if (is_string($_POST['login']) && is_string($_POST['password'])) {
    setcookie('login', $_POST['login'], time() + 365 * 24 * 3600, '/', 'phpp8', false, true);
    setcookie('password', $_POST['password'], time() + 365 * 24 * 3600, '/',' phpp8', false, true);
     header('location: /exercice 4/index.php');
